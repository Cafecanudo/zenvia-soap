...
public class ObjectFactory {
  ...
  public JAXBElement<CheckStatusByClientsId> createCheckStatusByClientsId(
    ...
    return new JAXBElement<CheckStatusByClientsId>(_CheckStatusByClientsId_QNAME,
  ...
  public JAXBElement<CheckStatusByClientsIdResponse> createCheckStatusByClientsIdResponse(
    ...
    return new JAXBElement<CheckStatusByClientsIdResponse>(_CheckStatusByClientsIdResponse_QNAME,
  ...
  public JAXBElement<CheckStatusResponse> createCheckStatusResponse(CheckStatusResponse value) {
    return new JAXBElement<CheckStatusResponse>(_CheckStatusResponse_QNAME,
  ...
  public JAXBElement<ErrorHandlingMT> createErrorHandlingMT(ErrorHandlingMT value) {
    return new JAXBElement<ErrorHandlingMT>(_ErrorHandlingMT_QNAME, ErrorHandlingMT.class, null,
        value);
  }
}
